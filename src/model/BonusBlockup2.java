...
import static model.GameData.upgrade2;
...
public class BonusBlockup2 extends BonusFigure {
    ...
    public BonusBlockup2(int x, int y) {
        super(x, y);
        super.health = 5;
        super.damage = 0;
        frame = 0;
        ...
        try {
            super.mainImage = ImageIO.read(getClass().getResource("/model/assets/block31.png")); //block8
    ...
    public void update() {
        ...
        if (super.state == GameFigureState.BLOCKBONUS_STATE_DAMAGED) {
          ...
          upgrade2 = new Upgrade(rand.nextInt(1100) + 1, rand.nextInt(500) + 1, 2);
           ...
           mfigures.add(upgrade2);
            super.state = GameFigureState.STATE_DONE;
            
            System.out.println("the size ::::::::" +  inventoryFigures.size() );
