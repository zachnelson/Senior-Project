...
import static model.GameData.upgrade4;
...
public class BonusBlockup4 extends BonusFigure {
  ...
  private int height;
    ...
    public BonusBlockup4(int x, int y) {
        super(x, y);
        super.health = 5;
        super.damage = 0;
        frame = 0;
        ...
        try {
            super.mainImage = ImageIO.read(getClass().getResource("/model/assets/block21.png")); // block 10 
