...
import static model.GameData.inventoryFigures;
import static model.GameData.miscFigures;
import static model.GameData.upgrade;
...
public class BonusBlockup extends BonusFigure {
...
private int height;
    ...
    public BonusBlockup(int x, int y) {
        super(x, y);
        super.health = 5;
        super.damage = 0;
        frame = 0;
        ...
        try {
            super.mainImage = ImageIO.read(getClass().getResource("/model/assets/block19.png"));// block7
...
//        System.out.println("Damage: " + damage);
    ...
    public void update() {
        ...
        //System.out.println( "the size of the slots:::::::::: " +  miscFigures.size() ); 
